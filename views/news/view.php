...
<div id="wrapper">
    ...
    <div id="page">
        ...
        <!-- end div#page -->
        <div id="footer">
            <p>Copyright &copy; 2015 Culinary. All Rights Reserved. Designed by <a href="http://www.freecsstemplates.org">FCT</a>.&nbsp;&nbsp;<a href="#">Privacy Policy</a> | <a href="#">Terms of Use</a></p>
        </div>
        <!-- end div#footer -->
    </div>
    <!-- end div#wrapper -->
